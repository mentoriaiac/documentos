...
composto de um App Service ([`azurerm_app_service`][azurerm_app_service]) e
dois App Service Slots
([`azurerm_app_service_slot`][azurerm_app_service_slot]), um para staging e
outro para produção.
